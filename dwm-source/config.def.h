...
static const unsigned int gappih = 10; /* horiz inner gap between windows */ // division entre bordes
...
static const int tagschemes[] = {SchemeTag1, SchemeTag2, SchemeTag3,
                                 ...
                                 SchemeTag7, SchemeTag8, SchemeTag6};
...
static const Layout layouts[] = {
    ...
    {"  DECK", deck},
    {"  BSTACK", bstack},
    {"  BHORIZONTAL", bstackhoriz},
    {"  GRID", grid},
    {"  ROW GRID", nrowgrid},
    {"  GRID HORIZ", horizgrid},
    {"  GAP GRID", gaplessgrid},
    {"  CENTER MASTER", centeredmaster},
    {"  CENTER FLOAT", centeredfloatingmaster},
    {"  TATAMI", tatami},
...
static const char *floatterm[] = {"/usr/share/archcraft/dwm/bin/dwmterm.sh",
                                  "--float", NULL};
static const char *fmcmd[] = {"/usr/share/archcraft/dwm/bin/dwmapps.sh",
                              "--file", NULL};
static const char *editcmd[] = {"/usr/share/archcraft/dwm/bin/dwmapps.sh",
                                "--editor", NULL};
...
static Key keys[] = {
    ...
    // Terminals -----------
    {MODKEY | ShiftMask, XK_e, spawn, {.v = neovide}},
    ...
    {MODKEY, XK_v, incnmaster, {.i = +1}}, // Verticle
    {MODKEY, XK_u, incnmaster, {.i = -1}}, // Horizontal

    /* Resize */
    {MODKEY | ShiftMask, XK_h, setmfact, {.f = -0.05}}, // Shrink left
    {MODKEY | ShiftMask, XK_l, setmfact, {.f = +0.05}}, // Shrink right
    ...
    // Layouts -----------
    {MODKEY | ShiftMask, XK_w, spawn, {.v = rofi_layoutcmd}},
