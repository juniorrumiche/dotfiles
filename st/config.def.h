 ...
 */
static  char *font = "JetBrainsMonoMedium Nerd Font:pixelsize=14:autohint=true:style=Medium" ;
static  char *font2[] = { "JetBrainsMonoMedium Nerd Font:pixelsize=14:autohint=true:style=Medium" };
